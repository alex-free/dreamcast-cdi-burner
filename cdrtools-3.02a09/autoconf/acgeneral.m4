...
EOF
  ...
  -version | --version | --versio | --versi | --vers)
    echo "configure generated by autoconf version AC_ACVERSION AC_ACVERSION_SCHILY"
    exit 0 ;;
...
[$1]
EOF
if AC_TRY_EVAL(ac_link) && test -s conftest${ac_exeext} && ($rmtcall ./conftest${ac_xexeext}; exit) 2>/dev/null
then
...
do
  ...
  -version | --version | --versio | --versi | --vers | --ver | --ve | --v)
    echo "$CONFIG_STATUS generated by autoconf version AC_ACVERSION AC_ACVERSION_SCHILY"
    exit 0 ;;
  -help | --help | --hel | --he | --h)
